...
<br>
<div>
<h2>sessionScope사용</h2>
<c:out value="${sessionScope.mName }"/>(<c:out value="${sessionScope.mId }"/>)
님 로그인 하셨습니다. <br>
접속 일자: <fmt:formatDate value="${sessionScope.date }" pattern="yyyy-MM-dd EEEE HH:mm"/>
</div>
